...
p([v,'C','Z','B',a,'R'],[c,z,b,r]).
p([x,n,'L','A'],[l,a]).
p([o,'L','G',q,q,'K',x,'B','P'],[l,g,k,b,p]).
p(['A',q,s,'I'],[a,i]).
p(['X',p,'D',u,'P','I'],[x,d,p,i]).
q([r,b,x,a,'O'],['F',o]).
q(['R','W','U','A','I'],[a,'Z',u,w,i,r]).
q(['H',f,y,j,u,'E',z,z,'O'],['A',e,o,h]).
q([j,'U',e,n,'J','K','K'],[u,q,k,j,k]).
q(['C','T',k,'X',a,'F',c,'K','W'],[c,x,t,k,w,'O',f]).
