...
p([m,'X',q,'I',y,'Z','B','T','W'],[x,i,z,b,t,w]).
p(['P','A',r,'L',m,l,e,'F'],[p,a,l,f]).
p([h,'J','T','O',h,l],[j,t,o]).
p([z,'K',r,'N','F','V','L',p],[k,n,f,v,l]).
p(['X','C',x,q,r,'B',e],[x,c,b]).
q(['F','C','P','A','L',i,k],[l,p,f,'T',c,a]).
q(['H','P',q,i,'A'],[h,a,'Y',p]).
q([o,u,v,s,'D','R',w,n],[r,'I',d]).
q([y,i,'P',i,i],['G',p]).
q(['K','H','E','O','D','Z',m,q,c],[k,w,z,e,h,d,o]).
