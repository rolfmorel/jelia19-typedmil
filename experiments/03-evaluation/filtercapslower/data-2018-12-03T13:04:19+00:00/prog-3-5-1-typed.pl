...
p([r,l,'G',g,o],[g]).
p([c,'Y',f,a,'F','G',u,'T'],[y,f,g,t]).
p(['B','L',y,r,m,g,'G',u],[b,l,g]).
p(['M','O',j,f],[m,o]).
p([e,k,d,'S','W'],[s,w]).
q([d,r,s,'G','Q','A',n,a],[c,g,q,a]).
q(['X','C','L','R','Z'],[k,z,x,l,c,r]).
q([s,'I','E',c,'Z',m,'C','N'],[c,n,e,i,n,z]).
q(['E',o,'O','V',f,t,a],[v,w,o,e]).
q(['R','R','K',o,n,b],[r,k,r,n]).
