...
[FO,'my_toupper',lambda n: "my_toupper{}(A,B):-upcase_atom(A,B),char_code(A,_).".format(n),'/2','[char,char]'],
[FO,'my_tolower',lambda n: "my_tolower{}(A,B):-downcase_atom(A,B),char_code(A,_).".format(n),'/2','[char,char]'],
...
[FO,'my_uppercase',lambda n: "my_uppercase{}(A):-upcase_atom(A,A),char_code(A,_).".format(n),'/1','[char]'],
[FO,'my_lowercase',lambda n: "my_lowercase{}(A):-downcase_atom(A,A),char_code(A,_).".format(n),'/1','[char]'],
]
...
#
  ...
  invocation = "learntyped(Pos,Neg,[list(list(int)),list(list(int))],H)" if types_enabled else "learn(Pos,Neg,H)"
