...
p([5,9,7,1,4,7,0,0,9],[8,0,0]).
p([2,0,1,7,2,1,0,4],[4,0,4,0,8]).
p([9,4,4,0],[8,8,0]).
p([0,5,7,2,1,7,4],[0,4,8]).
p([2,9,9,3,0,9],[4,0]).
q([0,3,0,7,0,3,0],[0,6,0,0,0]).
q([0,0,2,5,9,4,2],[4,8,0,0,3,4]).
q([7,2,0,2,7,0,0,7,7],[0,0,2,0,4,4]).
q([3,3,1,2,4,3,1,0,1],[0,8,1,4]).
q([1,1,9,1,4,5,9,2,7],[5,4,8]).
