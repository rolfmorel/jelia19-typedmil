...
p([9,3,1,1,4,5],[8]).
p([0,4,2,4,1],[0,8,4,8]).
p([4,4,3,9,7,0,0,9,5],[8,8,0,0]).
p([2,0,1,4,2,0,0,2],[4,0,8,4,0,0,4]).
p([9,0,0,4,5,3,9],[0,0,8]).
q([7,0,0,3,0,0,4,3],[0,0,0,0,4,8]).
q([4,4,2,5,7,9,3,7],[4,8,8,0]).
q([2,0,4,0,7],[0,0,4,0,8]).
q([2,4,5,4,4,4,5],[4,8,8,8,8,3]).
q([2,3,2,2,2,0],[4,0,4,7,4,4]).
