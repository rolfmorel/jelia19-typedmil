...
p([0,2,3,2,4,0,2,0],[0,4,4,8,0,4,0]).
p([7,4,1,4,0,9],[8,8,0]).
p([0,4,7,3],[0,8]).
p([2,2,1,0,4,0],[4,4,0,8,0]).
p([7,4,0,4],[8,0,8]).
q([2,4,3,0,0,0,2,0,0],[0,0,2,8,4,0,4,0,0]).
q([7,2,0,4],[0,8,2,4]).
q([7,2,0,4,0,2,4,4],[4,8,8,4,0,8,8,0]).
q([2,0,7,1,0,3,4],[8,0,4,8,0]).
q([2,4,0,4,0,7],[0,0,4,8,3,8]).
