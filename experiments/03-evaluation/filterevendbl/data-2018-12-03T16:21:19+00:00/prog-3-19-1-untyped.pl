...
p([1,7,4,4,4,0],[8,8,8,0]).
p([2,2,5,0,4,2,9],[4,4,0,8,4]).
p([2,7,2,9,5,7],[4,4]).
p([5,1,9,7,0,7,9,1],[0]).
p([0,2,0,5,3,2,1,3],[0,4,0,4]).
q([5,3,0,2,2,1,4],[0,8,4,4,9]).
q([2,5,5,2,2],[4,4,4,2]).
q([7,1,2,0,9,1,7,4],[9,4,8,0]).
q([1,1,5,4,9,5],[2,8]).
q([4,4,2,5,5,4,1],[8,4,8,8,1]).
