...
p([9,4,0,2,7,5,1,2],[8,0,4,4]).
p([7,1,5,7,7,0],[0]).
p([7,2,7,0,5,3],[4,0]).
p([4,4,3,5,3,1],[8,8]).
p([9,9,1,2],[4]).
q([0,2,9,2,0,0,2,0],[0,9,0,0,4,4,4,0]).
q([9,2,1,0,4,3,0],[8,4,0,6,0]).
q([4,2,0,5,9,2,4,4],[8,3,0,8,8,4,4]).
q([0,5,4,9,5,4,5],[0,8,5,8]).
q([4,2,0,0,0,2,0,1,5],[8,4,0,8,0,0,4,0]).
