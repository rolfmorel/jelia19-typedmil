...
p([9,4,0,4,5,4,1],[8,0,8,8]).
p([5,0,4,4,4,2,0,5],[0,8,8,8,4,0]).
p([9,1,3,0,1,2,7,1,0],[0,4,0]).
p([0,1,4,0,9],[0,8,0]).
p([2,2,0,9],[4,4,0]).
q([2,5,2,5,3],[4,4,9]).
q([1,1,3,5,0],[9,0]).
q([7,4,4,2,2,4],[8,4,8,4,8,4]).
q([2,3,3,5,5,0,2],[4,0,4,1]).
q([5,4,0,2,2,4],[0,4,4,8,0,8]).
