...
p([7,9,2,1,2,3,5,9,5],[4,4]).
p([9,3,5,4,0,2,4],[8,0,4,8]).
p([7,3,4,2,1],[8,4]).
p([2,5,4,4],[4,8,8]).
p([7,5,0,0,5,1,3,2],[0,0,4]).
q([2,4,7,7,7,0],[8,0,4,4]).
q([5,7,3,1,2,4,3,4],[4,8,9,8]).
q([1,0,9,1,3,2,7],[2,4,0]).
q([3,0,0,2],[0,0,3,4]).
q([1,3,4,4,7,4,0,5,2],[8,0,8,4,7,8]).
