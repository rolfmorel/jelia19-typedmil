...
p([5,9,2,4,1,7],[4,8]).
p([1,3,1,4,1,4,9,0],[8,8,0]).
p([2,4,4,4,4,9,9,4],[4,8,8,8,8,8]).
p([2,5,2,4,4,4,5,4],[4,4,8,8,8,8]).
p([7,4,0,1],[8,0]).
q([0,1,4,4,2,3,4,2,7],[0,8,8,8,4,9,4]).
q([2,9,4,2,3,0,1],[0,8,4,4,9]).
q([4,4,4,7,9,0],[0,8,8,8,4]).
q([4,9,3,4],[8,8,0]).
q([1,0,7,2,9],[4,0,5]).
