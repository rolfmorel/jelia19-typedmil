...
p([1,4,7,1,3,5,3,1,0],[8,0]).
p([4,9,3,7,3,3,9,3,0],[8,0]).
p([0,9,2,2,7,0,0,2],[0,4,4,0,0,4]).
p([4,1,4,0,2],[8,8,0,4]).
p([7,4,4,3,9,2],[8,8,4]).
q([3,7,2,4,0,0],[4,0,8,0,1]).
q([2,4,4,2,4,4,0,1],[8,4,4,8,0,8,8,1]).
q([4,0,1,0,1,2,2],[8,4,0,4,0,0]).
q([4,0,4,4,0,4,7,0,2],[0,0,8,0,3,8,4,8,8]).
q([0,9,2,9,5,9,2,1],[4,6,0,4]).
