...
p([1,4,5,3,5,4],[8,8]).
p([9,2,7,5,7],[4]).
p([0,2,0,7,9,5,0,2],[0,4,0,0,4]).
p([7,4,2,0,9,2],[8,4,0,4]).
p([4,2,4,2,0,1,3,4],[8,4,8,4,0,8]).
q([0,7,3,1,7,1],[0,6]).
q([2,0,1,1,2,7,2,9],[4,0,4,4,6]).
q([9,3,3,4,7,9,3,0,4],[8,2,8,0]).
q([4,3,0,5,5,1],[8,0,6]).
q([5,7,3,0,1,9,7,9,4],[8,0,0]).
