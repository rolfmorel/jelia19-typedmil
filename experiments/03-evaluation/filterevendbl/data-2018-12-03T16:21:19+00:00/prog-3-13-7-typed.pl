...
p([3,3,7,0],[0]).
p([9,5,3,9,0,5,9,1],[0]).
p([0,4,0,2,0,4,5],[0,8,0,4,0,8]).
p([0,7,5,9,1],[0]).
p([0,9,0,4,3,2,0],[0,0,8,4,0]).
q([2,2,7,0,2,9,2,1],[8,4,4,0,4,4]).
q([0,2,4,0,2,0,3,0],[0,0,8,0,4,0,4,9]).
q([7,7,7,7,4],[8,0]).
q([9,9,2,5,1,9,9,7,3],[4,8]).
q([1,3,4,1,2,5,2,2,2],[4,8,4,4,4,4]).
