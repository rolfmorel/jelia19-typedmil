...
p([4,0,3,7,4,0,4,2],[8,0,8,0,8,4]).
p([1,1,1,0,7,1,7,4],[0,8]).
p([0,0,4,2,3,0,0],[0,0,8,4,0,0]).
p([0,3,9,5,0],[0,0]).
p([4,1,2,9,2,0,4,0,0],[8,4,4,0,8,0,0]).
q([2,2,3,1,0,0],[4,8,0,4,0]).
q([1,9,1,9,4],[9,8]).
q([7,9,7,2],[4,9]).
q([7,3,3,1,7,5,0],[7,0]).
q([0,2,1,4,2,9],[0,8,0,4,4]).
